...
import ComplaintsHeatMap from './ComplaintsHeatMap';
...
const AdminStats = ({ PendingComplaints,
  ...
  return (
    <div className='mt-8 mr-2 ml-4'>
      ...
      <div className='bg-slate-900 mt-8 p-4 shadow-xl text-white flex flex-col justify-center items-center relative overflow-hidden'>
       <h2 className='font-extrabold pb-4'>Heat Map</h2>
        <ComplaintsHeatMap />
      </div>
    </div>
  );
